...
def upload_to_blobstore(block_blob_service, container_name, encoded_data: bytes,\
     file_ext: str, telemetry_client: TelemetryClient) -> int:
    """
    ...
    upload_result_statuscode = build_filename_and_upload(block_blob_service,\
         container_name, encoded_data, file_ext, telemetry_client)
    telemetry_client.flush()

    return upload_result_statuscode

def build_filename_and_upload(block_blob_service: BlockBlobService, container_name: str,\
     encoded_data: bytes, file_ext: str, telemetry_client: TelemetryClient) -> int:
    """
