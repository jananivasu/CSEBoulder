...
from settings import ACTIVE_DIRECTORY_APPLICATION_ID
from settings import ACTIVE_DIRECTORY_APPLICATION_SECRET
from settings import ACTIVE_DIRECTORY_TENANT_ID
...
class AutoUpdatedTokenCredential(TokenCredential):
    ...
    def get_token_func():
        ...
        context = adal.AuthenticationContext(
            str.format("https://login.microsoftonline.com/{}", ACTIVE_DIRECTORY_TENANT_ID),
